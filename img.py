...
def download_photo():
    url = "https://graph.facebook.com/v2.8/509679185734909/feed?fields=message,from,attachments,comments{message,comments},likes&limit=12&access_token=308758979483229%7C227308c4dceeb3bd9c35d8e7ffa25b59"
    r = requests.get(url)
